 ...
 *       &lt;sequence>
 *         &lt;element name="returnNames" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlRootElement(name = "INetworkAdapter_getPropertiesResponse")
public class INetworkAdapterGetPropertiesResponse {

    protected List<String> returnNames;
     ...
     * This is why there is not a <CODE>set</CODE> method for the returnNames property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getReturnNames().add(newItem);
     * </pre>
     * 
     * 
     * <p>
